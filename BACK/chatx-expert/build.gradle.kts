...
//    }
    maven {
        url = uri("http://nexus.daikuan.qihoo.net/nexus/content/groups/public")
...
// pluginDepends={platform, java}
val pluginDepends = properties("pluginDepends")
dependencies {
    intellijPlatform {
    ...
    implementation("com.qihoo.finance.lowcode:lowcode-common:1.0.4-SNAPSHOT") {
