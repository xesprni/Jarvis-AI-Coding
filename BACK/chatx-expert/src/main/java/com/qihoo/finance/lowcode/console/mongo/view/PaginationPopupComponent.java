...
import com.qihoo.finance.lowcode.console.mongo.view.model.NbPerPage;
...
//                : String.format("%s docs / page", nbPerPage.label);
        ...
        return String.format("%s docs / page", nbPerPage.label);
    }
    ...
    private void setDefaultForeground() {
        myValueLabel.setForeground(LafManager.getInstance().getCurrentUIThemeLookAndFeel().isDark() ? UIUtil.getLabelForeground() : UIUtil.getInactiveTextColor().darker().darker());
    }

    private void setOnHoverForeground() {
        myValueLabel.setForeground(LafManager.getInstance().getCurrentUIThemeLookAndFeel().isDark() ? UIUtil.getLabelForeground() : UIUtil.getTextFieldForeground());
    }
