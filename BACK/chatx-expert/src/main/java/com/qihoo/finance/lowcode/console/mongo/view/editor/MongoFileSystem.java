...
public class MongoFileSystem extends VirtualFileSystem implements NonPhysicalFileSystem {
    ...
    public void openEditor(final MongoVirtualFile mongoVirtualFile) {
        FileEditorManager fileEditorManager = FileEditorManager.getInstance(mongoVirtualFile.getProject());
        fileEditorManager.openFile(mongoVirtualFile, true);
        fileEditorManager.setSelectedEditor(mongoVirtualFile, MongoEditorProvider.ID);
    }
