...
import com.qihoo.finance.lowcode.gentracker.entity.AbstractGroup;
...
public class ExportImportComponent {
    ...
    private void handlerExportAction() {
        // 复制一份，避免篡改
        SettingsSettingStorage settingsStorage = CloneUtils.cloneByJson(SettingsStorageService.getSettingsStorage());
        // 创建一行四列的主面板
    ...
    private void handlerImportAction() {
        SettingsSettingStorage localSettings = SettingsStorageService.getSettingsStorage();
        SettingsSettingStorage remoteSettings = service.importConfig();
