...
package com.qihoo.finance.lowcode.console.mongo.model;
...
public class MongoQueryOptions {
    ...
    public void setOperations(String aggregateQuery) {
        ...
        for (Object operationObj : operations) {
            if (operationObj instanceof BasicDBList) {
                BasicDBList operationList = (BasicDBList) operationObj;
                for (Object o : operationList) {
                    BasicDBObject operation = (BasicDBObject) o;
                    this.operations.add(operation);
                }
                continue;
            }
            BasicDBObject operation = (BasicDBObject) operationObj;
            this.operations.add(operation);
        }
    }
