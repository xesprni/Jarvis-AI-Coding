...
import com.qihoo.finance.lowcode.gentracker.tool.HttpUtils;
...
public class NetworkExportImportSettingsServiceImpl implements ExportImportSettingsService {
    ...
    public void exportConfig(SettingsSettingStorage settingsStorage) {
        ...
        if (result != null) {
            ...
            try {
                ...
                method.invoke(null, ProjectUtils.getCurrProject(), result, GlobalDict.TITLE_INFO, AllIcons.General.InformationDialog, token, new NonEmptyInputValidator(), null, GlobalDict.PLUGIN_NAME);
    ...
    public SettingsSettingStorage importConfig() {
        ...
        // 解析数据
        return JSON.parse(result, SettingsSettingStorage.class);
    }
}
