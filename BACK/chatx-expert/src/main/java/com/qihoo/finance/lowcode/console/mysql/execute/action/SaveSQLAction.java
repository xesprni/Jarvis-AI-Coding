...
@Slf4j
public class SaveSQLAction extends AnAction implements Disposable {

    @Override
    public void actionPerformed(@NotNull AnActionEvent e) {
        log.info(Constants.Log.USER_ACTION, "用户保存SQL执行");
    ...
    private void save(Editor editor, VirtualFile file, Project project) {
        if (Objects.nonNull(editor) && Objects.nonNull(file)) {
            ...
            new SaveSQLDialog(project, file, queryDatabase, sql, history).showIfNew();
        }
    }
