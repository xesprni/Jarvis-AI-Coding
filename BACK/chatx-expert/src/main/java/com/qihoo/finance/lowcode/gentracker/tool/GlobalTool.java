...
import com.qihoo.finance.lowcode.gentracker.entity.DebugField;
import com.qihoo.finance.lowcode.gentracker.entity.DebugMethod;
...
public class GlobalTool extends NameUtils {
    ...
    public static final String CHINESE_REGEX2 = "[\u4E00-\u9FA5]";
    ...
    public static boolean matchChinese(char c){
        return String.valueOf(c).matches(CHINESE_REGEX2);
    }
    ...
    public static String lineToHump(String str) {
        ...
        while (matcher.find()) {
            ...
            str = str.replaceAll("-" + target, target.toUpperCase());
        }
        return str;
    }
