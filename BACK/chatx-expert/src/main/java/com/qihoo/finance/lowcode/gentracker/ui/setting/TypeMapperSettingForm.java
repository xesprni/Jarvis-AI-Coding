...
public class TypeMapperSettingForm implements BaseSettings {
    ...
    private void initTable() {
        ...
        // 第三列支持下拉框
        TableCellEditor javaTypeEditor = CellEditorFactory.createComboBoxEditor(true, FieldTypeMatch.DEFAULT_JAVA_TYPE_LIST);
        TableCellRenderer javaTypeRenderer = new ComboBoxTableRenderer<>(FieldTypeMatch.DEFAULT_JAVA_TYPE_LIST);
