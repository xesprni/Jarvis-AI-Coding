...
package com.qihoo.finance.lowcode.console.mongo.view.nodedescriptor;

import com.intellij.ui.ColoredTableCellRenderer;
import com.intellij.ui.ColoredTreeCellRenderer;
import com.intellij.ui.SimpleTextAttributes;
import com.qihoo.finance.lowcode.common.utils.LocalDateUtils;
import com.qihoo.finance.lowcode.console.mongo.utils.MongoUtils;
import com.qihoo.finance.lowcode.console.mongo.utils.StringUtils;
...
import static com.qihoo.finance.lowcode.console.mongo.utils.MongoUtils.WRITER_SETTINGS;
...
public class MongoValueDescriptor implements MongoNodeDescriptor {
    ...
    public String getKey() {
        if (value instanceof Document && ((Document) value).containsKey("_id")) {
            return String.format("[%s]   %s", index, ((Document) value).get("_id"));
        }
    ...
    private static class MongoDateValueDescriptor extends MongoValueDescriptor {
        ...
        private MongoDateValueDescriptor(int index, Date value) {
            super(index, value, StyleAttributesProvider.getDateAttribute());
        }
        ...
        private String getFormattedDate() {
            return LocalDateUtils.convertToPatternString((Date) value, LocalDateUtils.FORMAT_DATE_TIME);
        }
    }

    public static class MongoDocumentValueDescriptor extends MongoValueDescriptor {
