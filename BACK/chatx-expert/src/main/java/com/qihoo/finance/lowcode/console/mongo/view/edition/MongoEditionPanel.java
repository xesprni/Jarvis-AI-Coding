...
import com.qihoo.finance.lowcode.console.mongo.view.action.edition.AddKeyAction;
import com.qihoo.finance.lowcode.console.mongo.view.action.edition.AddValueAction;
import com.qihoo.finance.lowcode.console.mongo.view.action.edition.DeleteKeyAction;
import com.qihoo.finance.lowcode.console.mongo.view.model.JsonTreeNode;
import com.qihoo.finance.lowcode.console.mongo.view.model.JsonTreeUtils;
...
import static com.qihoo.finance.lowcode.console.mongo.utils.MongoUtils.DOCUMENT_CODEC;
...
public class MongoEditionPanel extends JPanel {
    ...
    MongoEditionPanel(final MongoPanel.MongoDocumentOperations mongoDocumentOperations, final MongoPanel.ActionCallback actionCallback) {
    ...
    public boolean save() {
        try {
            editTableView.editingStopped(null);
            Document mongoDocument = buildMongoDocument();
            boolean updated = mongoDocumentOperations.updateMongoDocument(mongoDocument);
            if (updated) {
            ...
            throw new RuntimeException("MongoDocument 保存失败");
...
//        PopupHandler.installPopupHandler(editTableView, actionPopupGroup, "POPUP", ActionManager.getInstance());
    ...
    boolean containsKey(String key) {
        ...
        while (children.hasMoreElements()) {
            ...
            if (descriptor instanceof MongoKeyValueDescriptor keyValueDescriptor) {
