...
public class MongoEditor extends UserDataHolderBase implements FileEditor {
    ...
    public MongoEditor(Project project, MongoVirtualFile mongoVirtualFile) {
        panel = new MongoPanel(project, mongoVirtualFile);
