...
package com.qihoo.finance.lowcode.console.mongo.view;
...
import com.qihoo.finance.lowcode.console.mongo.view.model.JsonTreeNode;
import com.qihoo.finance.lowcode.console.mongo.view.nodedescriptor.MongoNodeDescriptor;
import com.qihoo.finance.lowcode.console.mongo.view.renderer.MongoKeyCellRenderer;
import com.qihoo.finance.lowcode.console.mongo.view.renderer.MongoValueCellRenderer;
import com.qihoo.finance.lowcode.console.mongo.view.table.DateSpinnerCellEditor;
import com.qihoo.finance.lowcode.console.mongo.view.table.MongoValueCellEditor;
...
public class JsonTreeTableView extends TreeTable {
    ...
    private static final ColumnInfo<JsonTreeNode, MongoNodeDescriptor> READONLY_VALUE = new ReadOnlyValueColumnInfo();
    ...
    public JsonTreeTableView(TreeNode rootNode, ColumnInfo[] columnInfos) {
        ...
        setBackground(EditorComponentUtils.BACKGROUND);
        // 设置表头
        JTableUtils.setTableHeaderRenderer(this, Icons.Nodes.DataColumn);
    }
    ...
    private static class WritableColumnInfo extends ColumnInfo<JsonTreeNode, Object> {
        ...
        private static DateSpinnerCellEditor buildDateCellEditor(final JsonTreeNode treeNode) {
            // Note from dev:
            // Quite ugly because when clicking on the button to open popup calendar, stopCellEdition is invoked.
            ...
            // spinnerCellEditor.addActionListener(actionEvent -> treeNode.getDescriptor().setValue(spinnerCellEditor.getCellEditorValue()));

            final DateSpinnerCellEditor spinnerCellEditor = new DateSpinnerCellEditor();
            spinnerCellEditor.getSpinner().addChangeListener(actionEvent -> treeNode.getDescriptor().setValue(spinnerCellEditor.getCellEditorValue()));
