package com.qihoo.finance.lowcode.aiquestion.ui.layout;
...
public class MyBoxLayout implements LayoutManager2, Serializable {
    /**
    ...
    public MyBoxLayout(Container target, int axis) {
     ...
     *   null if none
     */
    MyBoxLayout(Container target, int axis, PrintStream dbg) {
        this(target, axis);
        this.dbg = dbg;
    }
