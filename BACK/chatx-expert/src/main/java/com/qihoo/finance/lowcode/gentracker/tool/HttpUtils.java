...
public final class HttpUtils {
     ...
     * 用户设备标识
     */
    private static final String USER_AGENT = GlobalDict.TITLE_INFO;
    /**
     * 内容类型标记
     */
    ...
    private static String handlerRequest(HttpUriRequest request) {
        try {
            ...
            if (response.getStatusLine().getStatusCode() != HttpStatus.SC_OK) {
                Messages.showWarningDialog("Error: 连接到服务器错误！", GlobalDict.TITLE_INFO);
                return null;
            }
            ...
            Messages.showWarningDialog("Error: 无法连接到服务器！", GlobalDict.TITLE_INFO);
