...
import com.qihoo.finance.lowcode.gentracker.ui.base.InputExistsValidator;
...
public class GroupNameComponent<E extends AbstractItem<E>, T extends AbstractGroup<T, E>> {
    ...
    private void init() {
        ...
        try {
            ...
            groupActionToolbar.setTargetComponent(groupActionToolbar.getComponent());
            ...
            log.warn("Group Toolbar: " + e.getMessage());
        }
    }
