...
//                McpTool::class,
            ...
            toolClasses.forEach { toolClass ->
                try {
                    ...
                    LOG.error("Failed to register tool from class ${toolClass.simpleName}: ${e.message}")
                }
            }
        } catch (e: Exception) {
            LOG.error("Failed to auto-register tools", e)
        }
    }
    ...
    fun register(tool: Tool<*>) {
        try {
            ...
            LOG.error("Failed to register tool instance", e)
        }
    }
