...
import com.qifu.utils.AgentLoader
import com.qifu.utils.SkillLoader
    ...
    init {
        ...
        DumbService.getInstance(project).runWhenSmart {
            with(Dispatchers.Default) {
                ...
                agentLoader.loadAllAgents(isRecordConfig = true, project = project)
                skillLoader.loadAllSkills(isRecordConfig = true, project = project)
            }
        }
    }
