package com.qifu.ui.smartconversation.settings.prompts
...
import com.qifu.ui.smartconversation.settings.configuration.PersonaDetailsState
import com.qifu.ui.smartconversation.settings.configuration.PersonaSettings
import com.qifu.utils.file.FileUtil.getResourceContent
import com.qihoo.finance.lowcode.smartconversation.utils.EditorActionsUtil

@Service
@State(
    name = "Jarvis_PromptsSettings",
    storages = [Storage("Jarvis_PromptsSettings.xml")]
)
