...
import com.qifu.ui.smartconversation.editor.ComponentFactory.EXPANDED_KEY
import com.qifu.ui.smartconversation.editor.ComponentFactory.MIN_LINES_FOR_EXPAND
import com.qifu.ui.smartconversation.editor.DiffSyncManager
import com.qifu.ui.smartconversation.editor.SearchReplaceHandler
...
import com.qifu.ui.smartconversation.sse.EditorState
...
class ResponseEditorPanel(
    ...
    companion object {
        val RESPONSE_EDITOR_DIFF_VIEWER_KEY =
            Key.create<UnifiedDiffViewer?>("jarvis.responseEditorDiffViewer")
        val RESPONSE_EDITOR_DIFF_VIEWER_VALUE_PAIR_KEY =
            Key.create<Pair<String, String>>("jarvis.responseEditorDiffViewerValuePair")
        val RESPONSE_EDITOR_STATE_KEY = Key.create<EditorState>("jarvis.responseEditorState")
    }

    private val logger = thisLogger()
    private val stateManager = EditorStateManager(project, disposableParent)
