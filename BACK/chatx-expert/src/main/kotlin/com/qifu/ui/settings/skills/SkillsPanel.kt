package com.qifu.ui.settings.skills
...
import com.qifu.ui.settings.skills.SkillDialogActions.showAddSkillDialog
...
class SkillsPanel(private val project: Project) : JPanel(BorderLayout()), Disposable {
